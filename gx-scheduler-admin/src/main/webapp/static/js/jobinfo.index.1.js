$(function() {
	    ...
	    "columns": [
	                ...
	                { 
	                	...
	                	"render": function ( data, type, row ) {
	            			var groupMenu = $("#taskGroup").find("option");
	            			for ( var index in $("#taskGroup").find("option")) {
            		...
            		},
					{
						...
						"visible" : true,
						"render": function ( data, type, row ) {
							var jobKey = row.taskGroup + "_" + row.id;
							return jobKey;
						}
					},
	                { "data": 'taskDesc', "visible" : true,"width":'20%'},
	                { "data": 'executorParam', "visible" : false},
					{ "data": 'taskCron', "visible" : true,"width":'10%'},
	                { 
	                	"data": 'addTime', 
	                	"visible" : false, 
	                	"render": function ( data, type, row ) {
	...
	$("#job_list").on('click', '.update',function() {
		...
		$('#updateModal .form select[name=taskGroup] option[value='+ row.taskGroup +']').prop('selected', true);
		$("#updateModal .form input[name='taskDesc']").val( row.taskDesc );
