...
import com.geostax.scheduler.admin.controller.interceptor.PermissionInterceptor;
import com.geostax.scheduler.admin.service.IScheduleTaskService;
import com.geostax.scheduler.admin.util.PropertiesUtil;
...
public class IndexController {
	...
	public String help() {
		...
		/*
		 * if (!PermissionInterceptor.ifLogin(request)) { return
		 * "redirect:/toLogin"; }
		 */
